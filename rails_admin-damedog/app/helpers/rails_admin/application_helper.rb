...
module RailsAdmin
  module ApplicationHelper
    ...
    def edit_user_link
      ...
      link_to rails_admin.url_for(action: edit_action.action_name, model_name: abstract_model.to_param, id: _current_user.id, controller: 'rails_admin/main'), class: 'pjax' do
        html = []
